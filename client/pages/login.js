        ...
        <div className="h-screen">
            ...
            <div className="w-5/6 lg:w-11/12 h-3/5 lg:h-3/4 bg-white mx-auto mt-4 lg:mt-20 rounded-lg flex flex-col lg:flex-row justify-between items-center lg:px-32 gap">
                ...
                <div className="w-full lg:w-96 h-5/6 lg:h-3/6 lg:bg-gray-200 rounded-lg mx-auto text-center lg:mt-10">
                    <form className="grid mt-20 lg:mt-20 justify-items-stretch w-3/4 mx-auto text-center">
                        ...
                        <input className="lg:px-28 py-2 lg:py-5 rounded bg-blue-500 mt-14 font-bold text-white" type="submit"></input>
                    </form>
                </div>
            </div>
        </div>
