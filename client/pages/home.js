            ...
            <div className="w-5/6 lg:w-11/12 h-3/5 lg:h-3/4 bg-white mx-auto mt-4 lg:mt-20 rounded-lg items-center lg:px-32 gap">
                <div className="pt-10 w-11/12 flex mx-auto text-center justify-between items-center">
                    <form className="w-full ml-0">
                        ...
                        <FontAwesomeIcon icon={faSearch} color="gray" size="lg" className="relative right-16 md:right-24 lg:right-32 mt-5" />
                    </form>
                    <div className="mr-20 mx-auto lg:mx-0 hidden lg:flex">
                        <button className="px-4 py-2 lg:px-7 lg:py-4 rounded bg-green-300 text-white font-bold mr-5 mt-5 lg:mt-0" onClick={addPatient}>Add Patient</button>
                        <button className="px-4 py-2 lg:px-7 lg:py-4 rounded bg-blue-300 text-white font-bold" onClick={setAppointment}>Set Appointment</button>
                    </div>
                    ...
                    <div className="flex lg:hidden gap-2 mx-auto mr-auto">
                        ...
                        <div className="bg-blue-400 w-16 h-16 rounded-full text-center"><FontAwesomeIcon icon={faCalendar} color="white" size="lg" className="mt-5 cursor-pointer" onClick={setAppointment}/></div>
                    </div>
