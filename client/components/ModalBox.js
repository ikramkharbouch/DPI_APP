...
const ModalBox = ({ classnames, closeBox }) => {
    ...
    return (<>
        <div className={`${classnames} text-3xl text-center bg-white h-4/5 md:h-3/6 lg:h-3/6 w-5/6 z-10 rounded mx-auto shadow-2xl absolute ml-auto mr-auto left-0 right-0 mt-14`}>
                ...
                <form className="flex flex-col flex-wrap mx-auto" onSubmit={SubmitHandler} >
                    ...
                    <div className="px-10 flex flex-col md:flex-row lg:flex-row gap-4 lg:gap-10 mx-auto pt-10 w-full">
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="text" className="py-2 lg:py-5 rounded border text-sm w-60 pl-20" placeholder="0655481976..." id="phone-number" />
                        </div>
                        ...
                        <div className="flex flex-col w-full md:w-4/5 lg:w-4/5">
                            ...
                            <div className="input border flex items-center w-full rounded h-10 lg:h-16 self-end mt-1">
                                <ul className="text-sm flex flex-wrap">
                                    {Tags.map((tag) => <div className="flex"><li key={tag} className="bg-green-100 px-6 md:py-1 rounded-full border text-green-400 font-bold border-green-400 ml-2 text-xs">#{tag}<FontAwesomeIcon icon={faTimes} color="gray" onClick={removeTag} size="sm" className='ml-1 absolute mt-0.5' /></li></div>)}
                                </ul>
